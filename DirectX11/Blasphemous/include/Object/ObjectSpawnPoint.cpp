...
void CObjectSpawnPoint::Spawn()
{
	...
	case EObjectSpawnType::NearingMonster:
		...
		break;
	case EObjectSpawnType::Pope:
		mSpawnObject = mScene->CreateObj <CPope>("Pope");
		break;
	case EObjectSpawnType::Pontiff:
		mSpawnObject = mScene->CreateObj<CPontiff>("PontiffFace");
		break;
	case EObjectSpawnType::BigSword:
		break;
	}
