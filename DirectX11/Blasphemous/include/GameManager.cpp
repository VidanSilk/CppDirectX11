...
bool CGameManager::mColliderDebugDraw = true;
bool CGameManager::mDrawQuadTree = true;
...
bool CGameManager::Init(HINSTANCE hInst)
{
	...
	lstrcpy(mClassName, TEXT("BlasPhemous_Jys"));
	lstrcpy(mTitleName, TEXT("Blas_Jys"));
	...
	CWidget::CreateUIProjection(static_cast<float>(RS.Width), static_cast<float>(RS.Height), 1000.0f);
...
bool CGameManager::Create()
{
	...
	mhWnd = CreateWindowW(mClassName, mTitleName, WS_OVERLAPPEDWINDOW,
		0, 0, 1280, 720, nullptr, nullptr, mhInst, nullptr);
