...
void CLog::PrintLogF(ELogPrintType PrintType, const char* Fmt, ...)
{
	char buffer[1024] = {};
	...
	PrintLog(std::string(buffer), PrintType);
}

void CLog::PrintLogF(const char* Fmt, ...)
{
	char buffer[1024] = {};
	...
	PrintLog(std::string(buffer), ELogPrintType::All);
}
